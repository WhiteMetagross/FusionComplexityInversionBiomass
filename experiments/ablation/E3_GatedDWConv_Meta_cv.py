...
Usage (WSL):
    ...
    python experiments/ablation/E3_GatedDWConv_Meta_cv.py
"""
...
class CFG:
    ...
    MODEL_DIR = str(PROJ_ROOT / 'output' / 'E3_GatedDWConv_Meta')
    OUTPUT_DIR = str(PROJ_ROOT / 'output' / 'E3_GatedDWConv_Meta')
